...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">Edycja dania</div>
            </div>
        </div>
        <form method="POST" action="#">
            <div class="card-body">
                ...
                <textarea rows="8" name="description" class="form-control tinymce{{ $errors->has('description') ? ' is-invalid' : '' }}">{{ $menu_foods->description }}</textarea>
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="custom-control custom-checkbox d-block w-100">
                        <input type="checkbox" class="custom-control-input" id="allergen-{{$allergen->id}}" name="id_allergens[]" value="{{$allergen->id}}" {{ (in_array($allergen->id, $allergens_selected) ? 'checked' : '') }}>
